...
import com.example.ngilmu_co.activities.EndCourseActivity;
...
public class BerandaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list_riwayat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent pilihsejarah = new Intent(getActivity(), EndCourseActivity.class);
